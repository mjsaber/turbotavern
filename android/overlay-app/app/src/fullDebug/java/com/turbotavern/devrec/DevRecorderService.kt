...
import com.turbotavern.BuildConfig
import java.io.File
...
class DevRecorderService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.turbotavern.DEVREC_START"
        const val ACTION_MARK = "com.turbotavern.DEVREC_MARK"
        const val ACTION_STOP = "com.turbotavern.DEVREC_STOP"
