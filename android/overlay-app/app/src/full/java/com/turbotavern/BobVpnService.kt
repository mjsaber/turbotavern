...
import com.turbotavern.core.ConnectionCoreProvider
...
import com.turbotavern.overlay.OverlayWindow
...
class BobVpnService : VpnService() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.turbotavern.START"
        const val ACTION_STOP = "com.turbotavern.STOP"
