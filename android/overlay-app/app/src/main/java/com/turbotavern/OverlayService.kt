...
import com.turbotavern.foreground.ForegroundQuery
import com.turbotavern.herotier.AndroidWindowHost
import com.turbotavern.herotier.Foreground
import com.turbotavern.herotier.HeroMatcher
import com.turbotavern.herotier.MediaProjectionGrabber
import com.turbotavern.herotier.MlKitHeroOcr
import com.turbotavern.herotier.OpacityCap
import com.turbotavern.herotier.OverlayBadgeRenderer
import com.turbotavern.herotier.PaddleHeroOcr
import com.turbotavern.herotier.StrictForeground
import com.turbotavern.herotier.TierOverlay
import com.turbotavern.herotier.TierTable
import com.turbotavern.trinket.OverlayTrinketRenderer
import com.turbotavern.trinket.SelectCoordinator
import com.turbotavern.trinket.SelectWindowArbiter
import com.turbotavern.trinket.TrinketMatcher
import com.turbotavern.trinket.TrinketOverlay
import com.turbotavern.trinket.TrinketTable
import java.io.File
...
class OverlayService : Service() {
    ...
    companion object {
        ...
        const val ACTION_ENABLE_TIER = "com.turbotavern.ENABLE_TIER"
        const val ACTION_DISABLE_TIER = "com.turbotavern.DISABLE_TIER"
        const val ACTION_STOP = "com.turbotavern.OVERLAY_STOP"
        const val ACTION_TIER_FORCE_OPEN = "com.turbotavern.TIER_FORCE_OPEN"   // debug
        const val ACTION_TIER_FORCE_CLOSE = "com.turbotavern.TIER_FORCE_CLOSE" // debug
