...
import com.turbotavern.herotier.BadgeView
import com.turbotavern.herotier.BoxPx
import com.turbotavern.herotier.WindowHost

/**
 * Renders the trinket-offer overlay: one S/A/B/C [BadgeView] above each offered trinket, plus a green
 * [TrinketHighlightView] ring around the recommended one. Mirrors the hero [com.turbotavern.herotier.TierOverlay]
